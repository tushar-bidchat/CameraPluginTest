...
- (void)constrain:(id)sender
{
    ...
    UIAlertAction *cancelAction = [UIAlertAction
                                   actionWithTitle:PELocalizedString(@"Cancel", nil)
                                   style:UIAlertActionStyleCancel
                                   handler:^(UIAlertAction *action)
                                   {
                                       [self clickedButtonWithIndex:0];
                                   }];
    ...
    UIAlertAction *button1Action = [UIAlertAction
                                   actionWithTitle:PELocalizedString(@"Original", nil)
                                   style:UIAlertActionStyleDefault
                                   handler:^(UIAlertAction *action)
                                  {
                                     [self clickedButtonWithIndex:1];
                                  }];
    
    UIAlertAction *button2Action = [UIAlertAction
                                    actionWithTitle:PELocalizedString(@"Square", nil)
                                    style:UIAlertActionStyleDefault
                                    handler:^(UIAlertAction *action)
                                    {
                                        [self clickedButtonWithIndex:2];
                                    }];
    UIAlertAction *button3Action = [UIAlertAction
                                    actionWithTitle:PELocalizedString(@"3 x 2", nil)
                                    style:UIAlertActionStyleDefault
                                    handler:^(UIAlertAction *action)
                                    {
                                        [self clickedButtonWithIndex:3];
                                    }];
    UIAlertAction *button4Action = [UIAlertAction
                                    actionWithTitle:PELocalizedString(@"3 x 5", nil)
                                    style:UIAlertActionStyleDefault
                                    handler:^(UIAlertAction *action)
                                    {
                                        [self clickedButtonWithIndex:4];
                                    }];
    UIAlertAction *button5Action = [UIAlertAction
                                    actionWithTitle:PELocalizedString(@"4 x 3", nil)
                                    style:UIAlertActionStyleDefault
                                    handler:^(UIAlertAction *action)
                                    {
                                        [self clickedButtonWithIndex:5];
                                    }];
    UIAlertAction *button6Action = [UIAlertAction
                                    actionWithTitle:PELocalizedString(@"4 x 6", nil)
                                    style:UIAlertActionStyleDefault
                                    handler:^(UIAlertAction *action)
                                    {
                                        [self clickedButtonWithIndex:6];
                                    }];
    UIAlertAction *button7Action = [UIAlertAction
                                    actionWithTitle:PELocalizedString(@"5 x 7", nil)
                                    style:UIAlertActionStyleDefault
                                    handler:^(UIAlertAction *action)
                                    {
                                        [self clickedButtonWithIndex:7];
                                    }];
    UIAlertAction *button8Action = [UIAlertAction
                                    actionWithTitle:PELocalizedString(@"8 x 10", nil)
                                    style:UIAlertActionStyleDefault
                                    handler:^(UIAlertAction *action)
                                    {
                                        [self clickedButtonWithIndex:8];
                                    }];
    UIAlertAction *button9Action = [UIAlertAction
                                    actionWithTitle:PELocalizedString(@"16 x 9", nil)
                                    style:UIAlertActionStyleDefault
                                    handler:^(UIAlertAction *action)
                                    {
                                        [self clickedButtonWithIndex:1];
    ...
    [self.actionSheet addAction:button1Action];
    [self.actionSheet addAction:button2Action];
    [self.actionSheet addAction:button3Action];
    [self.actionSheet addAction:button4Action];
    [self.actionSheet addAction:button5Action];
    [self.actionSheet addAction:button6Action];
    [self.actionSheet addAction:button7Action];
    [self.actionSheet addAction:button8Action];
    [self.actionSheet addAction:button9Action];
...
- (void) clickedButtonWithIndex:(int) buttonIndex
{
    if (buttonIndex == 0) {
